...
function create_defender (enemy){
	$("#defender")
		.html("<div id=\""+enemy+"\"><p>"+enemy+"</p><img src=\"assets/imgs/"+enemy+".jpeg\"></div>");
}
...
document.getElementById("luke").onclick = function(){
	...
	$("#your_char")
		.html("<div id=\""+player_char+"\"><p>Luke Skywalker</p><img src=\"assets/imgs/luke.jpeg\"></div>");

	//loop through the enemies array and adding divs under the enemies section of the page
	for(var i = 0; i<enemies_array.length; i++){
		console.log(i);
		$("#opponent_" + i)
		.html("<div id=\""+enemies_array[i]+"\"><p>"+enemies_array[i]+"</p><img src=\"assets/imgs/"+enemies_array[i]+".jpeg\"></div>");
	}
}
...
document.getElementById("yoda").onclick = function(){
	...
	//put the player character icon in the proper place in the page
	$("#your_char")
		.html("<div id=\""+player_char+"\"><p>yoda</p><img src=\"assets/imgs/yoda.jpeg\"></div>");
...
document.getElementById("vader").onclick = function(){
	...
	//put the player character icon in the proper place in the page
	$("#your_char")
		.html("<div id=\""+player_char+"\"><p>Darth Vader</p><img src=\"assets/imgs/vader.jpeg\"></div>");
...
document.getElementById("sidius").onclick = function(){
	...
	//put the player character icon in the proper place in the page
	$("#your_char")
		.html("<div id=\""+player_char+"\"><p>Darth Sidius</p><img src=\"assets/imgs/sidius.jpeg\"></div>");
